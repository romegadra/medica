      ...
      <Paper sx={{ p: 3 }} elevation={2}>
        <Stack spacing={2}>
          ...
          <Stack direction={{ xs: 'column', md: 'row' }} spacing={2}>
            ...
            />
            <Button variant="contained" color="warning" onClick={handleAdd} disabled={!doctorId || startTime >= endTime}>
              Bloquear
            </Button>
          </Stack>
          <Typography variant="body2" color="text.secondary">
            Puedes bloquear una fecha específica o un mismo horario para todos los lunes, martes, etc.
          </Typography>
        </Stack>
      </Paper>
